...
local opts = {
  ...
  -- Diagnostics configuration (for vim.diagnostics.config({..., noremap = true})) when diagnostics are on
  diagnostics = {
    virtual_text = true,
    underline = true,
  },
  ...
  lsp = {
    mappings = {
      n = {
        ["K"] = false, -- remove mapping because K is used for something else.
